...
Challenge-33
    ...
    variables) with name x and y of type int. The class needs to have two constructors. The first constructor does not have
    any parameters (no-arg constructor). The second constructor has parameters x and y of type int, and it needs to initialize
    the fields. Write the following methods (instance methods):
