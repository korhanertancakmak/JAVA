package Udemy.JavaProgrammingTimBuchalka.Exercies.Challenge0035_ComplexOperations;
...
Challenge-35
    ...
    a solution of the equation x2 = −1. Because no real number satisfies this equation, i is called an imaginary number.
    ...
    of type double. It represents the Complex Number. The class needs to have one constructor. The constructor has parameters
    real and imaginary of type double, and it needs to initialize the fields. Write the following methods (instance methods):
