...
Challenge-42
        ...
        Create a program using arrays that sorts a list of integers in descending order. Descending order is highest value
    to lowest. In other words if the array had the values in it [106, 26, 81, 5, 15] your program should ultimately have
    an array with [106, 81, 26, 15, 5] in it. Set up the program so that the numbers to sort are read in from the keyboard
    (Scanner).
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int size = 5, i = 0;
        int[] unsortedArray = SortedArray.getIntegers(size);
