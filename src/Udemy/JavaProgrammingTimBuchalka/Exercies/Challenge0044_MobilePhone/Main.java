...
Challenge-43
    ...
    1.  Implement the master class MobilePhone, that holds the ArrayList of Contacts, with the following attributes:
        ...
        -  And seven methods, they are (their functions are in their names):
            ...
            doesn't exist, or false if the contact already exists.
            -  updateContact(), has two parameters of type Contact (the old contact that will be updated with the new
            contact) and returns a boolean. Returns true if the contact exists and was updated successfully, or false if
            ...
            -  findContact(), has one parameter of type Contact and returns an int. The returned value is its position
            in the ArrayList, it will either be -1 (doesn't exist) or a value greater than or equal to 0 (does exists).
