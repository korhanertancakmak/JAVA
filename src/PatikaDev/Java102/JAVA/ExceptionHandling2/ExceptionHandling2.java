...
/**
 ...
 Also, if both n and p are zero, then the method must throw an exception which says 
...
The locked stub code in the editor reads the input and sends the values to the method 
as parameters.
